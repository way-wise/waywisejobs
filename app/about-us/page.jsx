    ...
    <main>
      ...
      <section className=" container max-w-[1200px] mx-auto px-4 py-[15px] flex gap-[30px]">
        <div>
          <div className="mb-[30px]">
            ...
            <h2 className="font-rajdhani text-[48px] text-[#2A37EA] leading-[53px] font-bold uppercase">
          ...
          <div className="flex items-center gap-2 mb-[15px]">
            <div className="flex items-center gap-4 p-[40px] border border-solid border-[#2A37EA] rounded-[30px]">
              <i
                ...
                style={{ fontSize: "45px", color: "#2A37EA" }}
              ></i>
              <p className="font-rajdhani font-bold text-[21px] leading-[30px] text-[#2A37EA]">
      ...
      <section className=" bg-gray-100 mt-[100px] space-y-10 pt-[100px]">
        <div className="container max-w-[1200px] mx-auto">
          <h2 className="font-rajdhani text-center text-[48px] text-[#2A37EA] leading-[53px] font-bold uppercase pb-[30px]">
