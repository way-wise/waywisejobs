...
export const ServiceCard = ({ title, description, image, link }) => {
  return (
    <div className="bg-white group flex flex-col justify-between">
      <div>
      ...
      <div className="px-[20px] pt-[20px] pb-[31px]">
        <h2 className="text-[20px] lg:text-[40px] md:text-[30px] font-bold text-black uppercase font-rajdhani leading-[28px] lg:leading-[61px] md:leading-[40px] mb-[8px]">
          {title}
        </h2>
      ...
      <div className="mx-[20px] mb-[18px] ">
        <Link
          href={link}
          className="rounded-md flex items-center justify-center gap-[10px] bg-[#2A37EA] text-white lg:text-[30px] md:text-[16px] font-bold font-rajdhani uppercase lg:leading-[38px] md:leading-[24px] leading-[24px] py-[13px] "
        >
          Explore
          <svg
