      ...
      <div className="container mx-auto">
        <div className="md:flex md:mt-[45px] mt-[20px]">
          <div className="gap-4 mt-[1px] md:mb-8 mb-4">
            <h1 className="lg:text-[92px] md:text-[60px] text-[40px] leading-[70px] font-rajdhani font-bold text-[#FF902E]">
              12
            </h1>
          ...
          <div className="w-full">
            <div className="bg-[#2A37EA] 2xl:h-screen md:h-[800px] h-[650px] md:pt-[65px] pt-[40px] md:pl-[45px] pl-[20px] md:pb-[15px] pb-[10px] flex flex-col">
              <h2 className="lg:text-[47px] md:text-[30px] text-[20px] leading-[54px] font-rajdhani font-semibold uppercase text-start text-white ">
